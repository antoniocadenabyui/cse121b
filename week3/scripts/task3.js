...
document.querySelector(`#odds`).innerHTML=array.filter(n => n%2);
// Step 4: Use the filter array method to find all of the even numbers of the array variable and assign the result to the HTML element with an ID of "evens"
document.querySelector(`#evens`).innerHTML=array.filter(n => n%2==0);
// Step 5: Use the reduce array method to sum the array variable elements and assign the result to the HTML element with an ID of "sumOfArray"
document.querySelector(`#sumOfArray`).innerHTML=array.reduce((pValue,cValue) => pValue + cValue,0);
// Step 6: Use the map array method to multiple each element in the array variable by 2 and assign the result to the HTML element with an ID of "multiplied"
document.querySelector(`#multiplied`).innerHTML=array.map(n => n*2);
// Step 7: Use the map and reduce array methods to sum the array elements after multiplying each element by two.  Assign the result to the HTML element with an ID of "sumOfMultiplied"
document.querySelector(`#sumOfMultiplied`).innerHTML=array.map(n => n*2).reduce((pValue,cValue) => pValue + cValue,0);